...
<div class="col-sm-12"> 
 ...
 <h4 class="card-title">عنوان صفحه </h4>
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="عنوان صفحه" name="name"  value="{{ old('name') }}"  required > 
 </div>
 ...
 <div class="form-group">	
								<h4 class="card-title">متن صفحه</h4>
...
<button type="submit" class="btn btn-success btn-block">ثبت صفحه</button> 
</div>				</div>
					</div>
				</div>
