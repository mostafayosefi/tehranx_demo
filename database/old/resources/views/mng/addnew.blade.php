...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="تیتر خبر" name="name"  value="{{ old('name') }}"  required > 
 </div>
...
<button type="submit" class="btn btn-success btn-block">ثبت خبر</button> 
</div>				</div>
					</div>
				</div>
