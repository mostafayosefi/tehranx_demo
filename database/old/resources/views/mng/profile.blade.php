...
<img class="profile-pic" src="{{env('APP_URL')}}/public/images/{{$superadmins->superadmin_img}}"
												alt="profile">
 <span class="profile-name">{{$superadmins->superadmin_name}}</span>
										</div>
...
{{$superadmins->superadmin_name}} 
 ...
 <p class="text-muted">
{{$superadmins->superadmin_username}} 
 </p> 
 </div>
...
<p class="text-muted">{{jDate::forge($superadmins->superadmin_logindate)->format('Y/m/d ساعت H:i a')}}</p></div>
...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="نام و نام خانوادگی" name="name" @if ($superadmins->superadmin_name) value="{{$superadmins->superadmin_name}}"@else value="{{ old('name') }}" @endif  required> 
</div>		
...
<input type="email" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="ایمیل" name="email" @if ($superadmins->superadmin_email) value="{{$superadmins->superadmin_email}}"@else value="{{ old('email') }}" @endif > 
</div>		
...
<input type="text"    class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="تلفن" name="tell" @if ($superadmins->superadmin_tell) value="{{$superadmins->superadmin_tell}}"@else value="{{ old('tell') }}" @endif > 
</div>		
...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="نام کاربری" name="username" @if ($superadmins->superadmin_username) value="{{$superadmins->superadmin_username}}"@else value="{{ old('username') }}" @endif required > 
</div>	
...
<form method="post" action="{{env('APP_URL')}}/manage/{{Session::get('arou')}}/profile/secret" >
