...
<body class="sidebar-dark rtl">
 ...
 <a href="{{env('APP_URL')}}/" class="noble-ui-logo d-block mb-2">ورود کاربران <span>سرویس پرداخت</span></a>
                    <h5 class="text-muted font-weight-normal mb-4">خوش آمدید! به حساب کاربری خود وارد شوید</h5>
 <form   action="{{env('APP_URL')}}/user/sign-in"  method="post"  data-toggle="validator" class="forms-sample  ">
 ...
 <a href="{{env('APP_URL')}}/user/register" class="d-block mt-3 text-muted">حساب کاربری ندارید؟ ثبت نام کنید</a>    
                    </form>
                  </div>
                </div>
              </div>
