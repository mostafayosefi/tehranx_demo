      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">مشاهده تیکتهای من</li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-md-9 grid-margin stretch-card">
                <h6 class="card-title"> لیست تیکتهای من</h6>
          </div>
          <div class="col-md-3 grid-margin stretch-card">
          
<td><a href="{{env('APP_URL')}}/user/addticket"   > 	 <button type="button" class="mb-1 btn btn-lg btn-primary"> ثبت تیکت جدید <i class="mdi mdi-check-circle"></i> </button></a></td>
          </div>
          </div>
...
@foreach($admins as $admin)
 ...
 <td>{{$i++}}</td> 
                        <td>{{$admin->tik_tit}} 
  @if($admin->tik_fromread=='0') <span class="badge badge-primary"  title="یک پیام جدید" >1</span> @endif </td> 
