...
<div class="form-group row">
 <label for="exampleInputUsername2" class="col-form-label">انتخاب سرویس</label>
 <div class="col-sm-11">
...
<div class="form-group row">
 <label for="exampleInputUsername2" class="col-form-label">مبلغ درخواستی</label>
 <div class="col-sm-11">
<input type="text" class="form-control" id="name"  autocomplete="off" placeholder="مبلغ درخواستی" name="curval"  value="1"  required > 
 </div>
 </div> 
...
<div class="form-group row">
 <label for="exampleInputUsername2" class="col-form-label">واحد پول</label>
 <div class="col-sm-11">
