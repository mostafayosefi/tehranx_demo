...
@foreach($admins as $admin)
 ...
 <td>
<a href="{{env('APP_URL')}}/user/viewsonlineshops/{{$admin->req_linkname}}/{{$admin->req_id}}/{{$admin->req_plan}}"  >
@if($admin->req_flg == '1')             
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="{{env('APP_URL')}}/user/viewsonlineshops/{{$admin->req_linkname}}/{{$admin->req_id}}/{{$admin->req_plan}}/delete" class="btn btn-danger"  >حذف</a> 
