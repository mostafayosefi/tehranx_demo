  @component('admin.layouts.content', [
      'title' => 'ویرایش نوع فیلد',
      'tabTitle' => ' ویرایش نوع فیلد',
      'breadcrumb' => [['title' => 'لیست انواع فیلد', 'url' => route('admin.form.form_field.index')], ['title' => 'ویرایش نوع فیلد  ',
      'class' => 'active']],
      ])
                  ...
                  <div class="col-md-12 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <form class="forms-sample" method="POST" action="{{ route('admin.form.form_field.update', $form_field) }}"
                                      ...
                                      <div class="col-sm-12">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="name" autocomplete="off"
                                                  placeholder=" نوع فیلد  " name="name" value="{{$form_field->name}}">
                                          </div>
...
<div class="form-check">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="multi"
            id="in" value="1" @if ($form_field->multi=='1') checked  @endif   >
        فعال
    </label>
</div>
...
<div class="form-check">
    <label class="form-check-label">
        <input type="radio" class="form-check-input" name="multi"
            id="in" value="0"   @if ($form_field->multi=='0') checked  @endif     >
        غیرفعال
    </label>
</div>
