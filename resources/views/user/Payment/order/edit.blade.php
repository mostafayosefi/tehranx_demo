@component('user.layouts.content', [
    'title' => 'ویرایش درخواست من'.'('.$form_data_list->form->name.')',
    'tabTitle' => ' ویرایش درخواست من'.'('.$form_data_list->form->name.')',
    'breadcrumb' => [['title' => 'لیست درخواست من  ', 'url' => route('user.payment.order.index')], ['title' => 'ویرایش درخواست من  '.'('.$form_data_list->form->name.')',
    'class' => 'active']],
    ])
                  ...
                  <div class="card-body">
                      ...
                      @include('admin.layouts.errors')
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-12">
                                  @include('admin.Eform.card.template' , ['guard' => 'user' , 'form'=> $form_data_list->form
                                   , 'user'=>$form_data_list->user , $currencies  , $form_data_list ,
                                    'route'=> route('user.payment.order.update', $form_data_list->id) , 'method' => 'update' ] )
                              </div>
