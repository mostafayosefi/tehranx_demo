@component('user.layouts.content', [
    'title' => 'مشاهده درخواست من'.'('.$form_data_list->form->name.')',
    'tabTitle' => ' مشاهده درخواست من'.'('.$form_data_list->form->name.')',
    'breadcrumb' => [['title' => 'لیست درخواست من  ', 'url' => route('user.payment.order.index')], ['title' => 'مشاهده درخواست من  '.'('.$form_data_list->form->name.')',
    'class' => 'active']],
    ])
              ...
              <div class="tab-pane pt-3 fade   @if (empty(Session::get('err'))) show active @endif  "
                  ...
                  <div class="row">
                      <div class="col-xl-12">
                          ...
                          @include('admin.order.table_show', [ 'aroue' => 'user'  ,   $form_data_list   , 'form'=> $form_data_list->form
                          , 'user'=>$form_data_list->user , $currencies  , $form_data_list ,
                           'route'=>  '#', $form_data_list->id ,
                           'method' => 'update'  ])
              ...
              <div class="tab-pane pt-3 fade  @if (Session::get('err') == '1') show active @endif "
                  ...
                  <div class="row">
                      <div class="col-xl-12">
                          ...
                          @include('admin.order.invoice', [ 'aroue' => 'user' ,$form_data_list  , $setting ])
